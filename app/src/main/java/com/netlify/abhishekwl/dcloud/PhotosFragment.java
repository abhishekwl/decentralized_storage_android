...
public class PhotosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        itemView = inflater.inflate(R.layout.fragment_photos, container, false);
    ...
    private void initializeViews() {
        ...
        photosRecyclerView.setLayoutManager(new LinearLayoutManager(itemView.getContext()));
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try {
                    ...
                    for (int i=0; i<responseJsonArray.length(); i++) {
                        ...
                        if (!isPrivate && (fileName.endsWith("jpg") || fileName.endsWith("jpeg") || fileName.endsWith("png") || fileName.endsWith("bmp") || fileName.endsWith("raw"))) {
                    ...
                    Objects.requireNonNull(getActivity()).runOnUiThread(() -> photosRecyclerView.setAdapter(postRecyclerViewAdapter));
